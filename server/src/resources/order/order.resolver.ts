...
export class OrderResolver {
  ...
  orders(@CurrentUser() user: TCurrentUser) {
  ...
  @UseGuards(IsAuthGuard)
  @Query(() => Order, { nullable: true })
  order(@Args('id') id: number, @CurrentUser() user: TCurrentUser) {
    const ability = this.ability.create(user)
  ...
  @UseGuards(IsAuthGuard)
  @Mutation(() => Boolean)
  async deleteOrder(@Args('id') id: number, @CurrentUser() user: TCurrentUser) {
    const ability = this.ability.create(user)
