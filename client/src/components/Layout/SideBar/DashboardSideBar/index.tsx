...
const SideBar: React.FC = ({ children }) => {
  ...
  return (
    <>
      <section tw="min-h-screen bg-blue-900 flex flex-col">
        <nav
          ref={navRef}
          css={[
        ...
        <div tw="ml-0 transition md:ml-60 py-6 px-3 md:(p-4 pl-0) flex-1 flex flex-col">
          <Header setShowSideBar={setShowSideBar} />
          <div tw="p-4 bg-gray-100 rounded-b-3xl flex-1 flex flex-col">
            {children}
          </div>
        </div>
