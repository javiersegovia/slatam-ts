...
import { useCreateCompanyMutation } from '../../graphql/hooks'
import { CreateCompanyInput, GetAllCategoriesQuery } from '../../graphql/schema'
...
import { GetAllCountriesQuery } from '../../graphql/schema'
...
interface ICompanyFormProps {
  ...
  countries?: GetAllCountriesQuery['getAllCountries']
}
      ...
      <div className="grid grid-cols-12 gap-4 row-gap-5 mt-5">
        ...
        <div className="col-span-12 flex items-center justify-center sm:justify-end mt-5">
          <Link href={routes.dashboard.index}>
            <a tw="justify-center block text-gray-700 mr-8">Skip</a>
          </Link>
          <Button
            size="SM"
            type="submit"
